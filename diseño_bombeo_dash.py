...
app.layout = html.Div([
    ...
    html.Div([
        ...
        html.Div([
            ...
            ], style={'width': '100%', 'marginBottom': '12px', 'display': 'flex', 'flexDirection': 'column'}),
            html.Div([
                html.Label([
...
@app.callback(
    ...
    [Input('btn-calc', 'n_clicks'),
     ...
     Input('input-tank-round', 'value'),  # <-- nuevo input
     Input('show-analysis', 'data')],
)
def update_dashboard(n_clicks, Q_lps, h_static, rpm, length, diam_mm, n_parallel, hw_c, eff_peak, elec_cost, tank_init, tank_min, days, hourly_str, rpm_combinada, tank_cap, tank_round, show_analysis):
    import traceback
    try:
