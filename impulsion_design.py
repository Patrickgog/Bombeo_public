...
class ImpulsionPotable:
    ...
    def __init__(self, Q: float, L: float, h0: float, pn_bar: float = 10):
        ...
        self.D = np.concatenate([np.arange(20, 600, 10), np.array([600, 700, 800, 900, 1000])])
    ...
    def plot(self):
        ...
        fig.write_html("grafica_impulsion.html")
        print("Gráfica guardada como grafica_impulsion.html. Ábrela manualmente en tu navegador.")
        fig.show()
